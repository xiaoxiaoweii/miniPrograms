...
let bmap = require('../../assets/bmap-wx.js')
...
Page({
  data: {
    ...
    message: '',
    cityDatas: {},
    icons: ['/assets/images/search_light.png', '/assets/images/search_light.png', '/assets/images/search_light.png', '/assets/images/search_light.png', '/assets/images/search_light.png'],
    // 用来清空 input
    searchText: '',
    // 是否已经弹出
    hasPopped: false,
    ...
    bcgImgList: [
      {
        src: '/assets/images/accomplishment-adventure-clear-sky-585825.jpg',
        topColor: '#393836'
      },
      {
        src: '/assets/images/accomplishment-adventure-clear-sky-585825.jpg',
